...
void Robojax_WCS::printDebug()
{
	...
	Serial.print(_sensitivity[_model]);
	Serial.println("mV/A");

	Serial.print("Zero Current Voltage: \t");
	Serial.print(_quiescent_Output_voltage[_model] * _sensitivity[_model]);
	Serial.println("mV");

	Serial.print("Voltage Reference: \t");
	Serial.print(_voltageReference);
	Serial.println("mV");

	Serial.print("Correction Value: \t");
	Serial.print(_correctionValue);
	Serial.println("mV");

	Serial.print("Bits Resolution: \t");
	Serial.print(_bitResolution);
	Serial.println(" bits");

	Serial.print("Wait for Zero Current: \t");
	Serial.print(_zeroCurrentWaitTime);
	Serial.println("mS");
